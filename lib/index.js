 ...
 * @param {Boolean} [options.whileTypingShowSuggestionsOnly=true] If `false`, indicates while typing the forwardGeocode and getSuggestions API will be called. If `true`, indicates that while typing only the getSuggestions API will be called and only suggestion results rendered.
...
MaplibreGeocoder.prototype = {
  options: {
    ...
    whileTypingShowSuggestionsOnly: false,
    minLength: 2,
  ...
  _handleInputChange: function (input) {
    ...
    if (
      this.geocoderApi.getSuggestions &&
      this.options.whileTypingShowSuggestionsOnly
    ) {
